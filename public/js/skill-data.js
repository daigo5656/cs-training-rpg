...
const SKILL_DATA = [
  ...
  { id: 1008, day: 1, category: "基礎理解・社内ルール", skillName: "初期研修（動画・広告基礎）", priority: "高",
    ...
    links: [
      { text: "AIOボットについて録画", url: "https://script.google.com/a/macros/e-tenki.co.jp/s/AKfycbz4vk2I4dAURXJglUzkkuU9JloV4SMR2_kIQtIxsNO5h6Th5KD70Us6XyivSB_JDbMT/exec" }
  ...
  { id: 1021, day: 4, category: "マーケティング・思考", skillName: "思考研修（採用・構造化・マーケ・クリエイティブ）", priority: "高",
    ...
    links: [
      { text: "中小企業のHP運用.pdf", url: "https://drive.google.com/file/d/17PiLGhU3ZY7bE4dygH-CVo4bkJ5LdQ_j/view?usp=drive_link" }
    ], testId: "thinking",
  ...
  { id: 1027, day: 15, category: "フォロー・提案", skillName: "クロス提案", priority: "高",
    objective: "売上の意識を持ち、顧客に最適な提案を考えられるようになる",
    inputTask: "クロスについて、クロスに関しての資料を学習する。完成版クロス資材を確認する",
  ...
  { id: 1028, day: 16, category: "フォロー・提案", skillName: "SWOT分析・ロープレ", priority: "高",
    ...
    links: [
      { text: "SWOT分析とは", url: "https://www.salesforce.com/jp/marketing/analytics/what-is-swot-analysis/" }
    ], testId: null, xp: 150 },
  ...
  { id: 1043, day: 14, category: "GA4・データ分析", skillName: "Googleビジネスプロフィール", priority: "中",
    ...
    links: [
      { text: "GBP登録方法", url: "https://meo-analytics.com/column/google-businessprofile-registration/" },
